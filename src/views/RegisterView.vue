    ...
    <div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
      <form class="bg-white">
        ...
        <div class="flex items-center border border-gray-400 py-2 px-3 rounded-2xl mb-4">
          ...
          <input class="pl-2 outline-none" type="text" id="name" name="name" v-model="name" placeholder="Nome" />
        </div>
        <div class="flex items-center border border-gray-400 py-2 px-3 rounded-2xl mb-4">
          ...
          <input class="pl-2 outline-none" type="text" id="nickname" name="nickname" v-model="nickname"
            placeholder="Apelido" />
        </div>
        <div class="flex items-center border border-gray-400 py-2 px-3 rounded-2xl mb-4">
          ...
          <input class="pl-2 outline-none" type="text" id="password" name="password" v-model="password"
            placeholder="Senha" />
        </div>
        <div class="flex items-center border border-gray-400 py-2 px-3 rounded-2xl">
          ...
          <input class="pl-2 outline-none" type="text" id="confirmpassword" name="confirmpassword"
            v-model="confirmpassword" placeholder="Confirmar Senha" />
        </div>
        <button type="submit" class="block w-full bg-[#527853] mt-4 py-2 rounded-2xl text-white font-semibold mb-2"
          @click.prevent="createNewUser()">Cadastrar</button>
