    ...
    <div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
      <form class="bg-white">
        ...
        <div class="flex items-center border border-gray-400 py-2 px-3 rounded-2xl mb-4">
          ...
          <input class="pl-2 outline-none" type="text" name="" v-model="newUser.name" placeholder="Nome" />
        </div>
        ...
        <div class="flex items-center border border-gray-400 py-2 px-3 rounded-2xl mb-4">
          ...
          <input class="pl-2 outline-none" type="text" name="" v-model="newUser.nickname" placeholder="Apelido" />
        </div>
        ...
        <div class="flex items-center border border-gray-400 py-2 px-3 rounded-2xl mb-4">
          ...
          <input class="pl-2 outline-none" type="text" name="" v-model="newUser.password" placeholder="Senha" />
        </div>
        ...
        <div class="flex items-center border border-gray-400 py-2 px-3 rounded-2xl">
          ...
          <input class="pl-2 outline-none" type="text" name="" v-model="newUser.confirmpassword" placeholder="Confirmar Senha" />
        </div>
...
<script>
// endpoint do registro de usuario: http://localhost:5000/users/register
